...
@section('content')
    ...
    <!-- Statistics Cards -->
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 p-4 gap-3">
        ...
        <div
            ...
            <div
                ...
                <svg class="h-8 w-8 text-blue-800 dark:text-gray-800" viewBox="0 0 24 24" fill="none" stroke="currentColor"
        ...
        <div
            ...
            <div
                ...
                <svg class="h-8 w-8 text-blue-800 dark:text-gray-800" width="24" height="24" viewBox="0 0 24 24"
